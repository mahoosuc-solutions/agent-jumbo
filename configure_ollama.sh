#!/bin/bash
# Configure Agent Mahoo to use Ollama with Qwen model

echo "Configuring Agent Mahoo to use Ollama with Qwen2.5-Coder..."

# Update the .env file to add Ollama configuration
cat >> /home/webemo-aaron/projects/agent-mahoo/.env << 'EOF'
...
echo ""
echo "Now you need to configure the chat model in the Agent Mahoo web UI:"
