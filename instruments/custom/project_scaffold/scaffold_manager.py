...
export const metadata: Metadata = {{
  ...
  description: '{vars.get("description", "Generated with Agent Mahoo")}',
}}
...
{vars.get("description", "Generated with Agent Mahoo")}
"""
...
This project was scaffolded with Agent Mahoo using the `{template["name"]}` template.
...
---
*Generated with Agent Mahoo Project Scaffold*
"""
