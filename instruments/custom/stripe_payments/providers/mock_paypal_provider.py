"""Mock PayPal provider for testing. Returns deterministic fake data."""
...
class MockPayPalProvider(PaymentProvider):
    """Deterministic mock PayPal provider. No network calls."""
    ...
    def create_subscription(
        ...
        return {
            ...
            "customer": customer_id,
            "status": "active",
            "approve_url": "https://www.sandbox.paypal.com/checkoutnow?token=mock",
            "provider": "paypal",
        }
    ...
    def update_customer_payment_method(self, customer_id: str, payment_method_token: str) -> dict:
        return {"status": "updated", "customer_id": customer_id, "provider": "paypal"}

    def retry_payment(self, payment_id: str) -> dict:
        return {"id": payment_id, "status": "paid", "provider": "paypal"}
