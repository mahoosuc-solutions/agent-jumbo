...
| Backup create and restore | ga | Operations | backup plus restore rehearsal | backup and restore log | stop launch if restore fails | ✅ Backup rehearsal 2026-04-05 — 231 files, ~1MB zip, all /aj/data DBs included — restore path pending full rehearsal |
