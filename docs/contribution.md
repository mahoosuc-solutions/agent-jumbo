# Contributing to Agent Jumbo

Contributions to improve Agent Jumbo are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the Agent Jumbo repository on GitHub.
...
- **Code Style:** Follow the existing code style. Agent Jumbo generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main Agent Jumbo repository.
...
- The documentation is built using Markdown. We appreciate your contributions even if you don't know Markdown, and look forward to improve Agent Jumbo for everyone's benefit.
