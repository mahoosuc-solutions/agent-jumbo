...
```text
ERROR: failed to build: failed to solve: error from sender: open /mnt/wdblack/dev/projects/agent-mahoo/docker/run/agent-mahoo/tmp/codex-home/tmp/arg0: permission denied
```
